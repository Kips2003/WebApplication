...
public class EmailRepository : IEmailRepository
{
    ...
    public async Task GivePrivilegeToUser(string email, string token,string privilege)
    {
        var message = new MimeMessage();
        message.From.Add(new MailboxAddress("gd-store.ge",_configuration["Smtp:SenderEmail"]));
        message.To.Add(new MailboxAddress(null, email));
        ...
        string htmlContent = 
            ...
            <body>
                <div class='container'>
                    <h1></h1>
                    <p>Your confirmation link is:</p>
                    <a href='https://gd-store.ge/givePrivilege.html?token={token}&privlege={privilege}'>Confirm your email</a>
                </div>
            </body>
            </html>";
